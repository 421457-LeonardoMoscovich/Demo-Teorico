...
@Component({
  ...
  template: `
    <section class="tarjeta ancho">
      ...
      <p class="ayuda">
        Estas dos cosas existen para mostrar decisiones de diseño que de otro modo sólo se ven en el
        log de Docker. Se borran cuando entre Kafka y cuando el Tema 03 sea un servicio real.
      </p>
      ...
      <article class="unidad">
        ...
        <p class="ayuda descripcion-unidad">
          ...
          el desafío allá. La consecuencia es que
          <strong>se puede armar un cuestionario aunque el Tema 03 esté caído</strong>. Apagalo y
          probá publicar: el contenido se guarda igual y lo único que falla es el desafío.
        </p>
      ...
      <article class="unidad">
        ...
        <p class="ayuda descripcion-unidad">
          ...
          Con una respuesta abierta, el alumno entrega y <strong>acá no pasa nada</strong> hasta que
          la profesora pone el último puntaje. Eso es el contrato asincrónico, visible.
        </p>
        ...
        @for (e of eventos(); track e.eventId; let idx = $index) {
          <div class="evento" [style.--orden]="idx">
            <p class="ayuda">
